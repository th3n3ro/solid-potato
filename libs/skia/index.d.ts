...
export interface CanvasKit {
    ...
    MakeSinglePagePDF(...args:SinglePagePDFParams): SinglePagePDF
    /**
...
export interface Canvas extends EmbindObject<"Canvas"> {
    ...
    setMatrix(
        ...
        persp0:number, persp1:number, persp2:number) :void
    /**
...
export interface SinglePagePDF {
    getCanvas(): Canvas
    export(): ArrayBuffer
}
...
export type SinglePagePDFParams = [emptyMetadataForExample: {}, spaceSize:{width:number; height:number}]